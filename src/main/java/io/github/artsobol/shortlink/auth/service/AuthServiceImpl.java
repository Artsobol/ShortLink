...
import io.github.artsobol.shortlink.refreshtoken.repository.RefreshTokenRepository;
import io.github.artsobol.shortlink.refreshtoken.service.RefreshTokenService;
import io.github.artsobol.shortlink.security.utils.TokenUtils;
...
import io.github.artsobol.shortlink.user.service.UserServiceImpl;
...
public class AuthServiceImpl implements AuthService {
    ...
    private @NonNull AuthResponse getAuthResponse(User user) {
        return new AuthResponse(
                ...
                new AuthResponse.UserInfo(user.getId(), user.getUsername(), user.getRoles())
        );
    }
